...
@RequestMapping("/blog")  // /blog로 시작하는 요청을 처리하는 controller가 된다.
...
public class MyController03 {
  ...
  public String blogDetail(HttpServletRequest request, Model model) {
    ...
    // model을 이용한 forward를 한다. (model을 사용해도 실제 내부는 request를 이용한 forward이다.)
  ...
  public String blogList(int blogNo, Model model) {
    model.addAttribute("blogNo", blogNo);
    return "blog/list";
  }
