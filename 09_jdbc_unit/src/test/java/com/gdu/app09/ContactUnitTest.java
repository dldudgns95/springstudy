...
public class ContactUnitTest {
  ...
  public void test01_삽입테스트() {
    ...
    int inserResult = contactDao.insert(contactDto);
    assertEquals(1, inserResult);  // insertResult가 1이면 테스트 성공이다.
  }
  ...
  public void test03_삭제테스트() {
    ...
    assertEquals(1, deleteResult);  // deletetResult가 1이면 테스트 성공이다.
