...
@Transactional  // 트랜잭션을 위한 annotation (AppConfig에 @EnableTransactionManagement도 사용해야 함)
...
public class ContactServiceImpl implements ContactService {
  ...
  @Override
  public int schedulerDelete() {
    int schedulerDeleteResult = contactDao.schedulerDelete();
    return schedulerDeleteResult;
  }
